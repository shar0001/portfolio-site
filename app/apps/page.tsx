...
export default function AppsPage() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Featured app ── large left column */}
        <div
        ...
        {/* Right column ── PM card + other apps */}
        <div className="col-span-1 md:col-span-5 flex flex-col gap-2.5">
          ...
          >
            ...
            <div>
              {pmSkills.map((s, i) => (
                ...
                >
                  <p className="text-sm mb-1 font-medium" style={{ color: '#7a7268' }}>
                    {s.label}
                  </p>
                  <p className="text-xs leading-relaxed" style={{ color: '#3c3a38' }}>
                    {s.desc}
                  </p>
                </div>
              ))}
          ...
          {rest.map(app => (
            ...
            >
              ...
              <p className="text-xs leading-relaxed mb-3" style={{ color: '#3c3a38' }}>
                {app.description}
              </p>
